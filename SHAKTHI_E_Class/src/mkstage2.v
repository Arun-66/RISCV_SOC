...
//
// On Sat Jul 12 22:57:15 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkstage2(CLK,
  ...
  assign rg_loadreserved_addr_D_IN =
	     { x__h7515 == 5'b00101 && rx_stage1_meta_first_x[41:40] == 2'd2,
	       alu_inputs[38:7] } ;
  ...
  assign alu_inputs_op1 =
	     rx_stage1_meta_first_x[48] ?
	       rx_stage1_control_first_x[31:0] :
	       op1__h3078 ;
  assign alu_inputs_op2 = _op2__h3081 ;
  always@(rx_stage1_meta_first_x or rx_stage1_control_first_x or op1__h3078)
  begin
    case (rx_stage1_meta_first_x[45:42])
      4'd1, 4'd4: alu_inputs_op3 = op1__h3078;
  ...
  assign IF_IF_ff_stage1_meta_w_data_whas__0_THEN_ff_st_ETC___d341 =
	     (x__h7515 == 5'b00111 && rx_stage1_meta_first_x[41:40] == 2'd2) ?
	       IF_rg_loadreserved_addr_21_BIT_32_22_AND_NOT_a_ETC___d340 :
	       alu_inputs[72:71] ;
  ...
  assign IF_ff_stage1_meta_w_data_whas__0_THEN_ff_stage_ETC___d200 =
	     rx_stage1_meta_first_x[63:59] == rdaddr__h4696 ;
  assign IF_ff_stage1_meta_w_data_whas__0_THEN_ff_stage_ETC___d202 =
	     rx_stage1_meta_first_x[58:54] == rdaddr__h4696 ;
  ...
  assign _theResult_____1_snd_aluresult__h8151 =
	     (NOT_alu_inputs_49_BITS_38_TO_7_68_EQ_IF_rg_loa_ETC___d337 ||
	      !rg_loadreserved_addr[32]) ?
	       32'd1 :
	       alu_inputs[70:39] ;
  ...
  assign s3regular_rdvalue__h8626 =
	     (rx_stage1_meta_first_x[45:42] == 4'd1) ?
	       x1_avValue_snd_aluresult__h8157 :
	       alu_inputs[70:39] ;
  assign s3system_rs1_imm__h8688 =
  ...
  assign v_trigger_enable_0_whas_AND_ff_stage1_dump_w_r_ETC___d21 =
	     ...
	     tx_stage3_dump_enq_rdy_b &&
	     ff_memory_request_FULL_N ;
  assign x1_avValue_snd_aluresult__h8157 =
	     (x__h7515 == 5'b00111 && rx_stage1_meta_first_x[41:40] == 2'd2) ?
	       _theResult_____1_snd_aluresult__h8151 :
	       alu_inputs[70:39] ;
  assign x__h7515 =
	     { rx_stage1_meta_first_x_BITS_7_TO_1__q1[0],
	       rx_stage1_meta_first_x_BITS_7_TO_1__q1[6:3] } ;
  always@(rx_stage1_meta_first_x or op2__h3079)
  begin
    case (rx_stage1_meta_first_x[47:46])
      2'd0: _op2__h3081 = op2__h3079;
      2'd1: _op2__h3081 = rx_stage1_meta_first_x[39:8];
      2'd2: _op2__h3081 = 32'd4;
      2'd3: _op2__h3081 = 32'd2;
    endcase
  end
  always@(IF_IF_ff_stage1_meta_w_data_whas__0_THEN_ff_st_ETC___d342 or
	  s3system_rs1_imm__h8688 or
	  ...
	  alu_inputs or s3regular_rdvalue__h8626)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !IF_ff_stage1_control_w_data_whas__84_THEN_ff_s_ETC___d277)
	begin
	  TASK_testplusargs___d387 = $test$plusargs("mstage2");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fetch_execute_pass &&
	  !IF_ff_stage1_control_w_data_whas__84_THEN_ff_s_ETC___d277)
	begin
	  TASK_testplusargs___d388 = $test$plusargs("l0");
	  #0;
	end
    NOT_IF_ff_stage1_control_w_data_whas__84_THEN__ETC___d391 =
	!IF_ff_stage1_control_w_data_whas__84_THEN_ff_s_ETC___d277 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_update_wEpoch)
	begin
	  TASK_testplusargs___d413 = $test$plusargs("mstage2");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_update_wEpoch)
	begin
	  TASK_testplusargs___d414 = $test$plusargs("l0");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_update_wEpoch)
