...
//
// On Sat Jul 12 22:57:16 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkriscv(resetpc,
  ...
  wire [63 : 0] fifof_2_D_IN, fifof_2_D_OUT;
  ...
  wire [63 : 0] stage1_ma_trigger_data2_t,
		...
		stage1_tx_stage1_meta_enq_data,
  ...
  wire [74 : 0] stage2_memory_request_get;
  wire [63 : 0] stage2_ma_trigger_data2_t,
		stage2_rx_stage1_dump_first_x,
		stage2_rx_stage1_meta_first_x,
  ...
  wire [32 : 0] stage2_mv_delayed_output;
  ...
  wire [32 : 0] stage3_ma_delayed_output_r;
  wire [31 : 0] stage3_flush_fst, stage3_mv_pmp_cfg;
  ...
  // submodule fifof_2
  FIFOL1 #(.width(32'd64)) fifof_2(.RST(RST_N),
				   .CLK(CLK),
				   .D_IN(fifof_2_D_IN),
				   .ENQ(fifof_2_ENQ),
				   .DEQ(fifof_2_DEQ),
