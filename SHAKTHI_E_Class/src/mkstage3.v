...
//
// On Sat Jul 12 22:57:11 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkstage3(CLK,
  ...
  reg NOT_wr_memory_response_08_BIT_34_09_60_OR_NOT__ETC___d272;
  ...
  wire [37 : 0] _dfoo10;
  wire [32 : 0] _dfoo14;
  wire [31 : 0] _theResult_____1_fst__h3926,
		_theResult____h3803,
		_theResult____h4688,
		_theResult____h5001,
		data__h3806,
		x__read_rdvalue__h6444;
  wire [5 : 0] type_cause__h5071;
  wire [4 : 0] x__read_rdaddr__h6443;
  ...
  assign wr_operand_fwding_wget =
		 ...
		 !rx_stage3_type_first_x[0] || ma_delayed_output_r[0] } :
	       { rx_stage3_common_first_x[5:1], _theResult____h5001, 1'd1 } ;
  ...
  assign wr_commit_wget =
	     (rg_epoch_20_EQ_IF_ff_stage3_common_w_data_whas_ETC___d121 &&
	      NOT_rg_rerun_18_36_AND_ff_stage3_type_w_data_w_ETC___d173) ?
	       { 1'd1, rx_stage3_common_first_x[5:1], data__h3806 } :
	       _dfoo10 ;
  ...
  assign _dfoo10 =
	     rg_epoch_20_EQ_IF_ff_stage3_common_w_data_whas_ETC___d194 ?
	       { 1'd1, rx_stage3_common_first_x[5:1], _theResult____h4688 } :
	       ((rx_stage3_type_first_x[35:34] == 2'd3) ?
		  38'h2000000000 :
		  { 1'd1,
		    rx_stage3_common_first_x[5:1],
  ...
  assign _dfoo25 =
	     ...
	     wr_memory_response_08_BIT_0_10_EQ_rg_epoch_20___d211 &&
	     !wr_memory_response[1] ;
  assign _theResult_____1_fst__h3926 =
	     (!ma_delayed_output_r[0] ||
	      rx_stage3_common_first_x[5:1] == 5'd0) ?
	       _theResult____h3803 :
	       ma_delayed_output_r[32:1] ;
  assign _theResult____h3803 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       rx_stage3_type_first_x[32:1] ;
  assign _theResult____h4688 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       csr_system_instruction[31:0] ;
  assign _theResult____h5001 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       wr_memory_response[33:2] ;
  assign csr_mv_curr_priv__77_CONCAT_ff_stage3_dump_w_d_ETC___d230 =
	     { csr_mv_curr_priv,
	       ...
	       (rx_stage3_type_first_x[35:34] == 2'd3) ?
		 37'd0 :
		 { rx_stage3_common_first_x[5:1], _theResult____h5001 } } ;
  assign data__h3806 =
	     rx_stage3_type_first_x[0] ?
	       _theResult_____1_fst__h3926 :
	       _theResult____h3803 ;
  ...
  assign x__h5352 = ~rg_epoch ;
  assign x__read_rdaddr__h6443 =
	     wr_operand_fwding_whas ? wr_operand_fwding_wget[37:33] : 5'd0 ;
  assign x__read_rdvalue__h6444 =
  ...
  begin
    ...
    NOT_wr_memory_response_08_BIT_34_09_60_OR_NOT__ETC___d272 =
	(!wr_memory_response[34] ||
	 !wr_memory_response_08_BIT_0_10_EQ_rg_epoch_20___d211) &&
